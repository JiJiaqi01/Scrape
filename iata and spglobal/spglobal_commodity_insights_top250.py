...
url='https://www.spglobal.com/commodityinsights/plattscontent/en/site-maps/top250-gea-gma-sitemap.xml'
...
for url in sites:
    ...
    #all url starts with https://www.spglobal.com/mobiliy/en/,
    #start from index 50
    name="ci_t250_"+url[50:]
