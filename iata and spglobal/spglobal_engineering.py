...
url='https://www.spglobal.com/engineering/en/sitemap.xml'
...
for url in sites:
    ...
    #all url starts with https://www.spglobal.com/commodityinsights/en/ci/, start from index 40
    name="engineering_"+url[40:]
