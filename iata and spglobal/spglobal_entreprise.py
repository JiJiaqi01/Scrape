...
url='https://www.spglobal.com/en/enterprise/sitemap.xml'
...
for url in sites:
    ...
    #all url starts with https://www.spglobal.com/en/enterprise/, start from index 39
    name="entreprise_"+url[39:]
